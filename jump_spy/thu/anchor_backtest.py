...
from indicators import StDev, Anchor
from backtest import BackTest, TradeType, DumpFormat
import calendar_calcs


class AnchorBackTest(BackTest):
    def __init__(self, security, json_config, ref_index=None):
        ...
        day_value = calendar_calcs.WEEKDAYS.index(self.settings.get('weekday',None))

        self.anchor = Anchor(day_value,derived_len=20)
